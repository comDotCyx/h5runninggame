...
Player.prototype.draw=function(ctx, intv)//intv:信息更新的间隔
{
	if(this.jumping)
	{
		this.jump();
	...
	else
	{
		...
		this.x=lerpDistance(this.side*this.initD*this.offsetRatio,this.x,0.8);
		this.angle=lerpAngle(this.toAngle*Math.PI/180,this.angle,0.7);
	}
